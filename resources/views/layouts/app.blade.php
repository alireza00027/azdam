 ...
 <head>
    ...
    <script>
        ...
        (function (d) {
            ...
            wf.src = {{asset('webTemplate/assets/js/webfont.js')}};
            wf.async = true;
            s.parentNode.insertBefore(wf, s);
        })(document);
    </script>

     <link rel="preload" href="{{asset('webTemplate/assets/vendor/fontawesome-free/webfonts/fa-regular-400.woff2')}}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{asset('webTemplate/assets/vendor/fontawesome-free/webfonts/fa-solid-900.woff2')}}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{asset('webTemplate/assets/vendor/fontawesome-free/webfonts/fa-brands-400.woff2')}}" as="font" type="font/woff2"
            crossorigin="anonymous">
    <link rel="preload" href="{{asset('webTemplate/assets/fonts/wolmart87d5.ttf?png09e')}}" as="font" type="font/ttf" crossorigin="anonymous">

    <!-- Vendor CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('webTemplate/assets/vendor/fontawesome-free/css/all.min.css')}}">
...
<body class="home bg-grey">
    <div class="page-wrapper">
        <h1 class="d-none">از دم-پاساژی برای شما</h1>
        <!-- Start of Header -->
        @include('layouts.sections.header.mainHeader')
        <!-- End of Header -->
        <!-- Start of Main -->
        <main class="main">
            ...
            <div class="dropdown-box">
                <div class="products">
                    <div class="product product-cart">
                        ...
                        <button class="btn btn-link btn-close" type="button"  aria-label="بستن">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="main-menu">
                    <ul class="mobile-menu">
                        <li><a href="demo11.html">خانه </a></li>
                        <li>
    ...
    <div class="newsletter-popup mfp-hide">
        <div class="newsletter-content">
            ...
            <p class="text-light ls-10">برای دریافت به روز رسانی پیشنهادهای ویژه در خبرنامه بازار وولمارت  مشترک شوید.</p>
                        ...
                        <div class="swiper-wrapper row cols-1 gutter-no">
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="webTemplate/assets/images/products/popup/1-440x494.jpg"
                                        data-zoom-image="webTemplate/assets/images/products/popup/1-800x900.jpg"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="webTemplate/assets/images/products/popup/2-440x494.jpg"
                                        data-zoom-image="webTemplate/assets/images/products/popup/2-800x900.jpg"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="webTemplate/assets/images/products/popup/3-440x494.jpg"
                                        data-zoom-image="webTemplate/assets/images/products/popup/3-800x900.jpg"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="webTemplate/assets/images/products/popup/4-440x494.jpg"
                                        data-zoom-image="webTemplate/assets/images/products/popup/4-800x900.jpg"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                        ...
                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                            <div class="product-thumb swiper-slide">
                                <img src="webTemplate/assets/images/products/popup/1-103x116.jpg" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="webTemplate/assets/images/products/popup/2-103x116.jpg" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="webTemplate/assets/images/products/popup/3-103x116.jpg" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="webTemplate/assets/images/products/popup/4-103x116.jpg" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                        </div>
                        <button class="swiper-button-next"></button>
            ...
            <div class="col-md-6 overflow-hidden p-relative">
                <div class="product-details scrollable pl-0">
                    ...
                    <div class="product-bm-wrapper">
                        <figure class="brand">
                            <img src="webTemplate/assets/images/products/brand/brand-1.jpg" alt="Brand" width="102" height="48" />
                        </figure>
    ...
    <!-- Plugin JS File -->
    <script src="{{asset('webTemplate/assets/vendor/jquery/jquery.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/parallax/parallax.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/jquery.plugin/jquery.plugin.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/skrollr/skrollr.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/zoom/jquery.zoom.js')}}"></script>
    <script src="{{asset('webTemplate/assets/vendor/jquery.countdown/jquery.countdown.min.js')}}"></script>

    <!-- Main JS -->
    <script src="{{asset('webTemplate/assets/js/main.min.js')}}"></script>
    @yield('script')
</body>
