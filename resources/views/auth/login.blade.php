    ...
    <main>
        <div class="mainContainer d-flex centered flex-column">
            ...
            <div class="col-10 col-sm-6 col-md-6 rounded p-3 mt-4 bg-white d-flex centered flex-column animation formContainer">
                <form action="{{route('login')}}" method="post" autocomplete="off" class="w-100 pb-2 px-3 py-4 needs-validation" novalidate>
                    @csrf
                    ...
                    <button class="btn btn-primary col-12 mb-3 mt-4" type="submit">ورود</button>
                    <a href="{{route('password.request')}}"class="btn bg-transparent forgetBtn col-12 mb-3 mt-3">فراموشی رمز</a>
                </form>
            </div>
